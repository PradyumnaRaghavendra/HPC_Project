    ...
    def train_step(self, batch: List[Dict]) -> tuple:
        ...
        try:
            ...
            if self.filter_enabled and self.uncertainty_filter.should_filter(self.step):
                ...
                if len(batch) == 0:
                    print("⚠️  Filtering removed all trajectories, skipping step")
                    return 0.0, {
            ...
            if num_tokens > 0:
                ...
                avg_advantage = 0.0
                avg_value = 0.0
                print(f"⚠️  Warning: No valid tokens in batch at step {self.step}")
    ...
    def behavior_cloning_warmstart(self, num_steps: int = 30):
        ...
        if env_type == 'maze':
            try:
                ...
                print("  ⚠️  No expert demos found, skipping warm-start")
                return
            ...
            try:
                ...
                print("  ⚠️  No WebShop expert demos found, skipping warm-start")
                return
        else:
            print(f"  ⚠️  No expert demos for environment '{env_type}', skipping warm-start")
            return
        ...
        for step in range(num_steps):
            ...
            for demo in all_demos:
                ...
                if 'prompt' in demo and 'target_action' in demo:
                    ...
                    print(f"⚠️  Skipping demo with unknown format")
                    continue
